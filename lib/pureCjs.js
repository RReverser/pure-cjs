var fs = require('fs'),
	...
	buildUmdBlock = require('./buildUmdBlock'),
...
exports.transform = function (inOptions) {
	var options = optionsParser(inOptions),
		...
		preamble = options.externals.length ? astConsts.extPreamble : astConsts.preamble;

		exportStatement = b[options.exports ? 'returnStatement' : 'expressionStatement'](b.callExpression(
				astConsts.require,
	...
	return map.whenAll().then(function (modules) {
		var factoryExpr = b.functionExpression(
				null,
				[],
				b.blockStatement(preamble.concat([
			...
			expr = (
				options.exports
				? b.callExpression(buildUmdBlock(options), [b.literal(options.exports), factoryExpr])
